...
const INITIAL_TASKS: Task[] = [
  ...
  {
    id: 2,title: 'Second Task',description:  'Description two',
  ...
  { id: 5,
    title: 'Fifth Task', description:   'Description five', priority: 'High', completed: false,
  },
]
...
function AppContent() {  const [tasks, setTasks] = useState<Task[]>(INITIAL_TASKS)
  ...
  const handleDelete = (
    ...
    if (
      window.confirm(    'Are you sure?'  )) {  setTasks((prev) =>    prev.filter(
          (t) => t.id !== id
        )  )  } }
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <ChallengeList />
            ...
            <Route
              path="/challenge/03-adding-new-tasks"   element={
                <TaskApp
                  tasks={tasks}   setTasks={
                    setTasks
                  }
                  showForm    countFormat="tasks"
                />
              }
            />
            ...
            <Route
              path="/challenge/05-task-deletion" element={
                <TaskApp  tasks={tasks}
                  setTasks={
                    setTasks
                  }
      showForm countFormat="tasks"  onDelete={
                    handleDelete
                  }
                />
              }
            ...
            <Route
              ...
              element={
                <TaskApp
                  ...
                  showForm countFormat="tasks"  showFilterBar
                />
              }
            />
         ...
         setTasks
            ...
            <Route
              ...
              element={
                <TaskApp
                  tasks={tasks}
                  setTasks={ setTasks  }  showForm  countFormat="tasks" 
                   showFilterBar     />             }
            />
            ...
            <Route    path="/challenge/11-useeffect-debounced-search"  element={
                <TaskApp       tasks={tasks}
                  setTasks={      setTasks
                  }     showForm  countFormat="tasks"  showFilterBar
                />
            ...
            <Route
              path="/challenge/13-due-dates-and-sorting"   element={
                <TaskApp
                  tasks={tasks}  setTasks={
                    setTasks
                  }  showForm   countFormat="tasks"   showFilterBar
            ...
            <Route
              ...
              element={
                <TaskApp  tasks={tasks}
                  ...
                  showForm  countFormat="tasks" showStatsPanel
                />
              }
            />
     ...
     showForm countFormat="tasks"
            ...
            <Route
              path="/challenge/21-react-router" element={
                <TaskApp  tasks={tasks} setTasks={
                    setTasks }
       showForm countFormat="tasks" linkToTaskDetail
                />
              } />
            ...
            <Route   path="/challenge/23-useref-focus-management"   element={
                <TaskApp tasks={tasks} setTasks={  setTasks
                  } showFormcountFormat="tasks" showFilterBar
                /> } />
          </Routes>
        </main>
      </div>
